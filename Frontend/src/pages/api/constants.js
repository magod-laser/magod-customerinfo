...
export const endpoints = {
	...
	getCustCodeByName: `${API}/customers/findcustcodebyname`,
	...
	getCompanyDetails: `${API}/customers/getcompanydetails`,
	sendAttachmentMails: `${API}/mailer/sendDirectMail`,
	getGenerateOSPdf: `${API}/customers/osgenerate-pdf`,
	getGenerateDuePdf: `${API}/customers/duegenerate-pdf`,

	dxfupload: `${API}/file/uploaddxf`,
	getDwgFiles: `${API}/file/getdxfnames`,
	renameFolderIfExists: `${API}/file/renamefolderifexists`,
	...
	getPaymentTerms: `${API}/customers/paymentterms`,

	getCustDues: `${API}/customers/customerdues`,
	getCustOverdues: `${API}/customers/customeroverdues`,
	...
	getProcessListsMch: `${API}/processlists/allprocesslistsmch`,
